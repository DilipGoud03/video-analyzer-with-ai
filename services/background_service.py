...
# ----------------------------
# Removes temporary video files older than 180 seconds from TEMP_DIR.
...
# --------------------------------
# Deletes any video files in ORG_DIR that are not recorded in the database.
# Ensures only valid and referenced videos remain.
...
# Scheduler Jobs
# --------------
# Adds scheduled jobs for cleaning up temporary and unwanted videos.
